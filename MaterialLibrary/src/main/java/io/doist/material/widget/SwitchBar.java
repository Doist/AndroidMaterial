...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    public SwitchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwitchBar, defStyleAttr,
    ...
    public void setTextViewLabel(boolean isChecked) {
        mTextView.setText(isChecked ? R.string.switchbar_on_text : R.string.switchbar_off_text);
    }
    ...
    private static void setMarginStartCompat(MarginLayoutParams lp, int marginStart) {
    ...
    private static void setMarginEndCompat(MarginLayoutParams lp, int marginEnd) {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
